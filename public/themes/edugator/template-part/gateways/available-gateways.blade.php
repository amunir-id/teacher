                        ...
                        <div class="stripe-credit-card-form-wrap ml-auto mr-auto py-5">
                            <form action="/charge" method="post" id="payment-form">
                                ...
                                <button type="submit" class="btn btn-purple" id="stripe-payment-form-btn">
                                    <span
                                        class="enroll-course-btn-text mr-4 border-right pr-4">{{ __t('enroll_in_course') }}</span>
                        ...
                        <div class="offline-payment-form-wrap pt-2 pb-5">
                            ...
                            <form action="{{ route('pay_offline') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="text-muted">
                                        <small>
                                            Write your payment method in details, elobrate as much as you can. We will
                                            verify payment and you will get course access after payment verification.
                                        </small>
                                    </p>
