                                ...
                                <form action="{{ route('add_to_cart') }}" class="add_to_cart_form" method="post">
                                    ...
                                    <div class="enroll-box-btn-group mt-3">
                                        ...
                                        <button type="button"
                                            ...
                                            data-course-id="{{ $course->id }}" name="cart_btn" value="add_to_cart"
                ...
                <div class="course-details-wrap">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="course-whats-included-box course-widget p-4">
                                    ...
                                    <ul>
                                        ...
                                        <li> <i class="la la-book"></i> {{ $lectures_count }} {{ __t('lectures') }}
                                        </li>
                                        @if ($assignments_count)
                                            <li> <i class="la la-tasks"></i> {{ $assignments_count }}
                                                {{ __t('assignments') }}</li>
                                        @endif
                                        @if ($attachments_count)
                                            <li> <i class="la la-file-download"></i> {{ $attachments_count }}
                                                downloadable
                                                resources </li>
                                        @endif
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($course->video_info())
                                    @include(theme('video-player'), [
                                        'model' => $course,
                                        'video_caption' => __t('preview'),
                                    ])
                                @else
                    ...
                    @if ($course->sections->count())
                        <div class="course-curriculum-header d-flex mt-5">
                            ...
                            <p class="ml-3 course-total-lectures-info">{{ $course->total_lectures }}
                                {{ __t('lectures') }}
                            </p>
                            <p class="ml-3 mr-3 course-runtime-info">
                                            ...
                                            @foreach ($section->items as $item)
                                                <div class="course-curriculum-item border-bottom pl-4 d-flex">
                                                    <p class="curriculum-item-title m-0 flex-grow-1">
                                                        ...
                                                        <a
                                                            href="{{ route('single_' . $item->item_type, [$course->slug, $item->id]) }}">
                                                    ...
                                                    <p class="course-section-item-details d-flex m-0">
                                                        <span class="section-item-preview flex-grow-1">
                                                            @if ($item->is_preview)
                                                                <a
                                                                    href="{{ route('single_lecture', [$course->slug, $item->id]) }}">
                                    ...
                                    <div class="single-review border-top d-flex my-3 py-3">
                                        <div class="reviewed-user d-flex">
                                            ...
                                            <div class="reviewed-user-name">
                                                ...
                                                <a
                                                    href="{{ route('profile', $review->user->id) }}">{!! $review->user->name !!}</a>
                                            </div>
                                        </div>
