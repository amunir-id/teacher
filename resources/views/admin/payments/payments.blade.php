...
@section('content')
    ...
    <form method="get">
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <div class="search-filter-form-wrap mb-3">
                    <div class="input-group">
                        <input type="text" class="form-control mr-3" name="q" value="{{ request('q') }}"
                            placeholder="Filter by Name, E-Mail">
                        <select name="filter_status" class="form-control mr-3">
                            ...
                            <option value="declined" {{ selected('declined', request('filter_status')) }}>declined
                            </option>
                        ...
                        <button type="submit" class="btn btn-primary btn-purple"><i class="la la-search-plus"></i> Filter
                            results</button>
                    </div>
                </div>
            </div>
        ...
        @if ($payments->count() > 0)
            <p class="text-muted my-3"> <small>Showing {{ $payments->count() }} from {{ $payments->total() }}
                    results</small> </p>
                ...
                @foreach ($payments as $payment)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{!! route('payment_delete', $payment->id) !!}" class="btn btn-danger delete_confirm"><i
